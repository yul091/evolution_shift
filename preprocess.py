...
def process_file(file_path, data_file_role, dataset_name, word_to_count, path_to_count, max_contexts):
    ...
    if total != 0:
        ...
        print('Average total contexts: empty!')
        print('Average final (after sampling) contexts: empty!')
        print('Total examples: empty!')
...
if __name__ == '__main__':
    ...
    parser.add_argument("-ted1", "--test_data1", dest="test_data1_path",
                        help="path to test data1 file", required=False)
